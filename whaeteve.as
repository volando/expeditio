package
{
	...
	public class GameState extends FlxState
	{
		...
		[Embed(source="../media/bluedoor.png")] 
		protected var BlueDoorImage:Class;
		
		[Embed(source="../media/bluekey.png")] 
		protected var BlueKeyImage:Class;
		
		[Embed(source="../media/ladder.png")] 
		protected var LadderImage:Class;
		...
		protected var blueKey:FlxSprite = null;
		...
		public function GameState()
		{
			...
			levelBlocks.add(
				this.add(
					new FlxBlock(
						(LEVEL_DIMENSIONS>>1) - BLOCK_DIMENSIONS*3,
			...
			levelBlocks.add(
				this.add(
					new FlxBlock(
						...
						BLOCK_DIMENSIONS,
						BLOCK_DIMENSIONS*2,
						LEVEL_DIMENSIONS - BLOCK_DIMENSIONS*6,
						TechTilesImage
					)
				)
			);
			...
			for (var j:int = 0; j < COINS_COUNT; ++j)
			{
				coins.add(
					this.add(
						new Coin(
							CoinsImage, 
							((LEVEL_DIMENSIONS>>1) + BLOCK_DIMENSIONS * 8) + j * BLOCK_DIMENSIONS,
							LEVEL_DIMENSIONS - BLOCK_DIMENSIONS
						)
					)
				);
